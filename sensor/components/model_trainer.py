...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> artifact_entity.ModelTrainerArtifact:
        try:
            ...
            raise SensorException(f"Attribute error: {str(e)}. Check the input artifact.", sys)
        except Exception as e:
            raise SensorException(e, sys)
...
# class ModelTrainer:
#     def __init__(self,model_trainer_config:config_entity.ModelTrainerConfig,
#                  data_transfromation_artifact:artifact_entity.DataTransformationArtifact):
...
#             logging.info(f"calculation f1 train score")
#             yhat_train=model.predict(x_train)
#             f1_train_score=f1_score(y_true=y_train,y_pred=yhat_train)
            
#             logging.info(f"calculation f1  test score")
#             yhat_test=model.predict(x_test)
#             f1_test_score=f1_score(y_pred=yhat_test,y_true=y_test)
...
#                     expected accuracy:{self.model_trainer_config.expected_score}---model acutal score:{f1_test_score}")
...
#             #prepare artifact
#             logging.info(f"prepare thhe artifact")
